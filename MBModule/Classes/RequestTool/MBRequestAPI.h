...
/** 审核状态的接口*/
#define REVIEW_STATE_API        @"/index.php/index/Tlogin/is_pwd"
/** 审核状态下登录接口*/
#define REVIEW_Login_API        @"/index.php/index/Tlogin/login"
...
/** 苹果内支付验签*/
#define APPLE_RECEIPT_API           @"/index.php/Home/Index/apple_pay"
